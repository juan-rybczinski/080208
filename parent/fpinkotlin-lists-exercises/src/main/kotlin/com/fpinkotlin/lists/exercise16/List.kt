...
fun triple(list: List<Int>): List<Int> = list.foldLeft(List()) { acc -> { x -> acc.cons(x * 3) } }

//fun triple(list: List<Int>): List<Int> = list.foldRight(List()) { x -> { acc: List<Int> -> acc.cons(x * 3) } }